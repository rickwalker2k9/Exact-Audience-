...
export const MCCARTY_MOVED_VOTERS = [
  ...
  { id: "mv-007", name: "Tracy Hatfield",   city: "Tulsa",         originalIntent: "Undecided", currentIntent: "McCarty", exposures: 6, lastSignal: "Watched 'Contrast 15-1' on Fox News 3x", movedDate: "May 28", score: 84 },
  ...
  { id: "mv-011", name: "Sharon Maxey",     city: "Jenks",         originalIntent: "Undecided", currentIntent: "McCarty", exposures: 6, lastSignal: "Watched 'Bio 15-2' on Court TV + email open", movedDate: "May 28", score: 85 },
...
export const MCCARTY_VISITORS = [
  { id: "v1",  name: "Carol Bentley",    city: "Tulsa",          mood: "Accountability Voters",  score: 94, signal: "Watched News on 6 debate replay",         intent: "McCarty"    as const },
  ...
  { id: "v3",  name: "DeEtte Doerr",     city: "Tulsa",          mood: "Accountability Voters",  score: 88, signal: "Watched debate on YouTube",                intent: "McCarty"    as const },
  ...
  { id: "v7",  name: "Randy Lopp",       city: "Tulsa",          mood: "Accountability Voters",  score: 92, signal: "Shared debate clip on Facebook",            intent: "McCarty"    as const },
  ...
  { id: "v11", name: "Kathleen Petersen",city: "Broken Arrow",   mood: "DV Reform Voters",       score: 96, signal: "Donated to campaign, watched debate",       intent: "McCarty"    as const },
  ...
  { id: "v18", name: "Suzie Sells",      city: "Tulsa",          mood: "Accountability Voters",  score: 80, signal: "Facebook comment on debate post",           intent: "Moved→McCarty" as const },
