...
export const MCCARTY_VOTER_PROFILES: BuyerProfile[] = [
  // ─── Profile 1: Carol Bentley — High-Intent Civic Voter ───────────────────
  {
    ...
    mediaRecommendations: [
      { channel: "CTV — Fox News / NewsNation", allocation: 45, tactic: "1–2 final impressions of 'Accountability :30' — she watches primetime news. Time delivery for 6–9 PM window.", color: "#c8102e" },
  ...
  // ─── Profile 2: Randy Lopp — Crime-Concerned Persuadable ──────────────────
  {
    ...
    mediaRecommendations: [
      { channel: "CTV — Pluto TV / Tubi", allocation: 50, tactic: "Serve 'Accountability :30' — he has completed 'Taxpayer Waste' twice. Rotate to the contrast message to build frequency on a new angle. Target 6–10 PM window.", color: "#ef4444" },
      { channel: "YouTube Pre-roll", allocation: 25, tactic: "Serve 'Debate Highlight :15' on Tulsa news content — he watches YouTube news. High relevance match.", color: "#ff0000" },
      { channel: "Reddit Display", allocation: 15, tactic: "Serve banner ad on r/tulsa — he is already active in the DA race thread. Low CPM, high relevance.", color: "#ff4500" },
