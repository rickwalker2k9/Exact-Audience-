...
export const BARRETT_VISITORS = [
  { first: "Garrison",  last: "Ashby",  city: "Scottsdale",  zip: "85251", income: "$162,000",  networth: "$480,000",  credit: "A+", job: "Senior Software Engineer", company: "Intel",        score: 95, mood: "Move-Up Buyer",    time: "1m ago" },
  ...
  { first: "Preston",  last: "Wentworth", city: "Scottsdale",  zip: "85255", income: "$328,000",  networth: "$1,380,000",credit: "A+", job: "Orthopedic Surgeon",  company: "Mayo Clinic AZ",  score: 98, mood: "Jumbo Buyer",      time: "19m ago" },
  ...
  { first: "Garrison",   last: "Delacroix",  city: "Surprise",    zip: "85374", income: "$68,000",   networth: "$84,000",   credit: "B+", job: "Electrician",         company: "Rosendin",        score: 74, mood: "VA Loan Eligible", time: "31m ago" },
