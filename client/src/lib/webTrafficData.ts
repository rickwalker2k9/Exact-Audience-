...
export const BREEZE_WEB_TRAFFIC: DashWebTraffic = {
  ...
  trafficSplitNote: "Ads are split evenly between both destinations, but actual traffic behavior shows 76.4% landing on incomeprotectioncalculator.com and 23.6% on the Breeze affiliate link. All 39 confirmed leads came through the calculator funnel. SiteID.ai identifies 53% of visitors across both destinations.",
  landingDestinations: [
    {
      ...
      identifiedPct: 53,
      color: "#0ea5e9",
      note: "76.4% of actual traffic lands here despite even ad spend split — indicating stronger organic pull and better ad relevance to this destination. All 39 confirmed leads completed the 6-step calculator and opted in here. Full funnel tracking active: opt-ins, step completions, and retargeting all tracked.",
    },
    {
      ...
      identifiedPct: 53,
      color: "#10b981",
      note: "Receives 23.6% of actual traffic despite equal ad budget allocation. Installing a pixel on the Breeze affiliate page would unlock full funnel analytics and close the attribution gap.",
    },
  ],
};
