...
export const BREEZE_BUYER_PROFILES: BuyerProfile[] = [
  {
    ...
    engagementScore: 94,
    signals: [
      { date: "May 2", channel: "PolicyGenius", action: "Ran comparison quote", detail: "Compared 4 carriers on PolicyGenius — did not click through to any", strength: "medium", phase: "lookback" },
      ...
      { date: "May 7", channel: "NorthwesternMutual.com", action: "Research visit", detail: "Reviewed income protection guides — downloaded PDF", strength: "medium", phase: "lookback" },
      { date: "May 9", channel: "Ladderlife.com", action: "Research visit", detail: "Checked coverage tiers — compared $5K vs $8K monthly benefit", strength: "medium", phase: "lookback" },
      ...
      { date: "May 18", channel: "Email", action: "Opened EA email", detail: "Subject: 'See how much income protection you need in 30 seconds' — opened, clicked", strength: "very-high", phase: "campaign" },
      { date: "May 19", channel: "incomeprotectioncalculator.com", action: "First site visit", detail: "Landed on calculator — completed Step 1 (income) then closed", strength: "high", phase: "campaign" },
  ...
  },
  {
    ...
    signals: [
      ...
      { date: "May 4", channel: "GuardianLife.com", action: "Research visit", detail: "Reviewed disability income riders — compared benefit periods", strength: "medium", phase: "lookback" },
      { date: "May 6", channel: "SunLife.com", action: "Research visit", detail: "Reviewed group disability insurance options", strength: "low", phase: "lookback" },
      ...
      { date: "May 10", channel: "Ethos.com", action: "Started application", detail: "Entered personal info — name, DOB, address", strength: "high", phase: "lookback" },
      { date: "May 11", channel: "Ethos.com", action: "Completed health questionnaire", detail: "Answered all health questions — received $42/mo quote for $5K/mo benefit", strength: "very-high", phase: "lookback" },
      { date: "May 12", channel: "Ethos.com", action: "Did not finalize", detail: "Ethos quote received: $42/mo — closed browser without purchasing", strength: "high", phase: "lookback" },
      { date: "May 16", channel: "Google Search Ad", action: "Saw EA ad", detail: "Clicked 'Income Protection Calculator' search ad", strength: "very-high", phase: "campaign" },
      ...
      { date: "May 20", channel: "incomeprotectioncalculator.com", action: "First site visit", detail: "Landed on calculator — completed Steps 1-3 then closed", strength: "high", phase: "campaign" },
      { date: "May 24", channel: "incomeprotectioncalculator.com", action: "Return visit + conversion", detail: "Returned, completed all 6 steps — scheduled coverage review ✓", strength: "very-high", phase: "campaign" },
    ],
    purchaseWindows: [
