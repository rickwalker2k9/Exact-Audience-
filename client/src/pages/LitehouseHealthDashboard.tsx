...
const SITE_VISITORS = [
  {
    name: "Deborah Zimmerman", title: "VP of Nursing Operations", org: "Froedtert Health",
    city: "Milwaukee", state: "WI",
    visits: 7, lastSeen: "Today, 9:14 AM",
    timeOnSite: "11m 42s",
    pages: ["/beacon", "/beacon#how-it-works", "/request-your-demo"],
    tier: "HOT PROSPECT — Demo Request Page",
    tierColor: C.orange,
    income: "$195K–$230K",
    phone: "(414) 777-8000",
    email: "d.zimmerman@froedtert.com",
    linkedin: "linkedin.com/in/deborah-zimmerman-froedtert",
    address: "9200 W Wisconsin Ave, Milwaukee, WI 53226",
    outreach: "Deborah has visited the Beacon product page 7 times and landed on the demo request page — she's ready. Lead with the shift cost math ($5,100 → $2,424) and reference Froedtert's 500+ beds. Offer a 20-minute live demo this week.",
  },
  {
    name: "Michael Hicks", title: "Chief Nursing Officer", org: "OhioHealth",
    city: "Columbus", state: "OH",
    visits: 5, lastSeen: "Today, 11:33 AM",
    timeOnSite: "8m 17s",
    pages: ["/beacon", "/clinicians", "/about-us"],
    tier: "HIGH INTENT — Product Deep Dive",
    tierColor: C.gold,
    income: "$280K–$340K",
    phone: "(614) 544-4455",
    email: "m.hicks@ohiohealth.com",
    linkedin: "linkedin.com/in/michael-hicks-ohiohealth",
    address: "180 E Broad St, Columbus, OH 43215",
    outreach: "Michael reviewed the Beacon product page, the clinician marketplace, and the About Us page — he's evaluating the full platform. Lead with the EOR model and the internal-first allocation story. Reference OhioHealth's 12 hospitals.",
  },
  {
    name: "Sandra Colón", title: "Director of Workforce Management", org: "Memorial Hermann Health System",
    city: "Houston", state: "TX",
    visits: 4, lastSeen: "Yesterday, 3:48 PM",
    timeOnSite: "6m 55s",
    pages: ["/beacon#integrations", "/beacon#analytics"],
    tier: "ACTIVE EVALUATOR — Integration Research",
    tierColor: C.teal,
    income: "$145K–$175K",
    phone: "(713) 338-4000",
    email: "s.colon@memorialhermann.org",
    linkedin: "linkedin.com/in/sandra-colon-memorialhermann",
    address: "929 Gessner Rd, Houston, TX 77024",
    outreach: "Sandra focused on integrations and analytics — she's likely comparing Beacon against their existing UKG setup. Lead with the UKG integration story and Tableau analytics. Offer a technical demo with your integration team.",
  },
  {
    name: "James Whitfield", title: "CFO", org: "Prisma Health",
    city: "Greenville", state: "SC",
    visits: 3, lastSeen: "Today, 8:02 AM",
    timeOnSite: "5m 30s",
    pages: ["/beacon", "/beacon#savings"],
    tier: "FINANCIAL BUYER — Cost Reduction Focus",
    tierColor: C.gold,
    income: "$310K–$380K",
    phone: "(864) 455-7000",
    email: "j.whitfield@prismahealth.org",
    linkedin: "linkedin.com/in/james-whitfield-prismahealth",
    address: "300 E McBee Ave, Greenville, SC 29601",
    outreach: "James is a CFO focused on the savings page — he's running the numbers. Lead with the $5,100 → $2,424 shift cost reduction, annualize it for Prisma's 18 hospitals, and show him the payback period. This is a financial ROI conversation.",
  },
  {
    name: "Rachel Torres", title: "VP of Human Resources", org: "Centura Health",
    city: "Englewood", state: "CO",
    visits: 2, lastSeen: "Today, 10:15 AM",
    timeOnSite: "4m 12s",
    pages: ["/clinicians", "/about-us"],
    tier: "EARLY STAGE — Awareness",
    tierColor: C.tealDim,
    income: "$160K–$195K",
    phone: "(303) 290-6500",
    email: "r.torres@centura.org",
    linkedin: "linkedin.com/in/rachel-torres-centura",
    address: "9100 E Mineral Ave, Englewood, CO 80112",
    outreach: "Rachel is early-stage, reviewing the clinician marketplace and About Us. Send a warm intro email with the one-page Beacon overview. Don't push for a demo yet — nurture with the travel nurse cost data and a case study.",
  },
];
